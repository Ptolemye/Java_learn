...
<img src="./image/image-20260509102801646.png" alt="image-20260509102801646" style="zoom:67%;" />

显然这三种逻辑全部写在Controller里面过度耦合了
...
对于`service`，`controller`，`dao` 一个接口`Interface`一个实现`Impl`
